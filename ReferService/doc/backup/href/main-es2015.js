...
const routes = [
    ...
    {
        path: 'home',
        loadChildren: () => Promise.all(/*! import() | page2-page2-module */[__webpack_require__.e("common"), __webpack_require__.e("page2-page2-module")]).then(__webpack_require__.bind(null, /*! ./page2/page2.module */ "./src/app/page2/page2.module.ts")).then(m => m.Page2PageModule)
    },
    // {
    //   path: 'page2',
    ...
    {
        path: 'page3',
        loadChildren: () => Promise.all(/*! import() | page3-page3-module */[__webpack_require__.e("common"), __webpack_require__.e("page3-page3-module")]).then(__webpack_require__.bind(null, /*! ./page3/page3.module */ "./src/app/page3/page3.module.ts")).then(m => m.Page3PageModule)
    },
    {
        path: 'more',
    ...
    {
        path: 'complete',
        loadChildren: () => Promise.all(/*! import() | complete-complete-module */[__webpack_require__.e("common"), __webpack_require__.e("complete-complete-module")]).then(__webpack_require__.bind(null, /*! ./complete/complete.module */ "./src/app/complete/complete.module.ts")).then(m => m.CompletePageModule)
    },
    {
        path: '**',
        redirectTo: 'home'
...
const environment = {
    ...
    contextRoot: '',
    //contextRoot: '/href',
    //API_SERVER: "http://localhost:8080/sendReferData" 
    //API_SERVER: "http://localhost:8080/ReferService/sendReferData" 
    API_SERVER: "https://2ua2220310.vnsny.org:8443/ReferService/sendReferData"
};
/*
...
module.exports = __webpack_require__(/*! D:\Workspace_IJ\HReferal\H-Referal\src\main.ts */"./src/main.ts");

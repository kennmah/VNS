...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["page3-page3-module"], {
  /***/
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/page3/page3.page.html":
  /*!*****************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/page3/page3.page.html ***!
    \*****************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPage3Page3PageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<ion-content>  \n<ion-grid id=\"grid\">\n    <ion-row>\n    <ion-col size=\"12\" style=\"padding: 0\">\n      <form #patForm=\"ngForm\" (ngSubmit) = \"submit(patForm)\" autocomplete=\"off\">\n      <div ngModelGroup=\"patContact\" #contact=\"ngModelGroup\" autocomplete=\"off\">\n      <div class=\"img_header\" style=\"margin:0; padding:0;\">     \n        <img id=\"imgFrame\" [src] = \"formHeaderUrl\" class=\"img_cover\">\n        <span class=\"titleTxt\">Patient's Contact Info</span>\n      </div>\n      <div>\n        <ion-label position=\"stacked\" class=\"label\">Patient First Name *</ion-label>\n        <ion-input [ngModel]=\"patientDetails?.first_name\" required placeholder=\"First Name\" \n          name=\"first_name\" autofocus clearInput inputmode=\"text\" class=\"medium shortTxt\" autocomplete=\"chrome-off\"></ion-input>\n      </div>        \n      <div>\n        <ion-label position=\"stacked\" class=\"label\">Patient Last Name *</ion-label>\n        <ion-input [ngModel]=\"patientDetails?.last_name\" required \n          name=\"last_name\" placeholder=\"Last Name\" clearInput inputmode=\"text\" class=\"medium shortTxt\"  autocomplete=\"chrome-off\"></ion-input>\n      </div>\n      <div>\n        <ion-label position=\"stacked\" class=\"label\">Gender *</ion-label>\n        <ion-select [ngModel]=\"patientDetails?.gender\" required name=\"gender\" interface=\"popover\" placeholder=\"Gender\" class=\"medium exShortTxt\">\n          <ion-select-option value=\"M\">Male</ion-select-option>\n          <ion-select-option value=\"F\">Female</ion-select-option>\n          <ion-select-option value=\"Other\">Other</ion-select-option>          \n        </ion-select> \n      </div>\n      <div>\n        <ion-label position=\"stacked\" class=\"label\">DOB *</ion-label>\n        <ion-input      \n        [ngModel]=\"patientDetails?.dob\"\n          required                         \n          #dob          \n          name=\"dob\" \n          type=\"text\"\n          placeholder=\"MM/DD/YYYY\"                \n          class=\"medium exShortTxt\"\n          clearInput \n          pattern=\"[0-9]{2}/[0-9]{2}/[1,2][0-9]{3}\"      \n          (ionBlur)=\"formatDob(dob)\"\n        >\n\n        <!-- -->\n        </ion-input>        \n      </div>\n      <div>\n          <ion-label position=\"stacked\" class=\"label\">Patient/Caregiver Phone *</ion-label>\n        <ion-input \n        [ngModel]=\"patientDetails?.phone\" \n          #patPhone\n          required \n          name=\"phone\" \n          pattern=\"[0-9]{3}-[0-9]{3}-[0-9]{4}\" \n          placeholder=\"000-000-0000\" \n          type=\"tel\" \n          inputmode=\"tel\" \n          clearInput \n          class=\"medium exShortTxt\"\n          autocomplete=\"chrome-off\"\n          (ionBlur)=\"formatPhone(patPhone)\">\n        </ion-input>\n      </div>\n      <div>\n        <ion-label position=\"stacked\" class=\"label\">Address *</ion-label>\n        <ion-input [ngModel]=\"patientDetails?.street\" required name=\"street\" placeholder=\"Street\" class=\"medium shortTxt\" autocomplete=\"chrome-off\"></ion-input>\n        <ion-input [ngModel]=\"patientDetails?.city\" required name=\"city\" placeholder=\"City\" class=\"medium  exShortTxt\" autocomplete=\"chrome-off\"></ion-input>\n        <!-- <input list=\"stateList\" ngModel required name=\"state\" [value]=\"defaultState\"  class=\"medium txt\" style=\"width: 5em;\"> -->\n        <!-- <datalist id=\"stateList\">\n          <option value=\"{{ state.abbreviation }}\" title=\"{{ state.name }}\" *ngFor=\"let state of stateService.state\"> {{ state.abbreviation  }}</option>\n        </datalist>    -->\n        <ion-select [ngModel]=\"patientDetails?patientDetails.state:defaultState\" required name=\"state\" interface=\"popover\" class=\"medium\" style=\"width: 5em;\">          \n          <ion-select-option value=\"{{ state.abbreviation }}\" title=\"{{ state.name }}\" *ngFor=\"let state of stateService.state\"> {{ state.abbreviation  }}</ion-select-option>\n        </ion-select>\n        <ion-input \n            [ngModel]=\"patientDetails?.zipcode\"\n            required \n            name=\"zipcode\" \n            placeholder=\"Zip Code\" \n            type=\"text\" \n            clearInput \n            class=\"medium\" \n            style=\"width: 8em;\" \n            minlength=\"5\"\n            pattern=\"[0-9]{5,9}\"\n            autocomplete=\"chrome-off\"\n            >\n        </ion-input>\n      </div>\n      <div>\n        <ion-label position=\"stacked\" class=\"label\">Primary Insurance</ion-label>\n        <input\n          list=\"insuranceList\"\n          [ngModel]=\"patientDetails?.pri_insurance\"                              \n          name=\"pri_insurance\" \n          placeholder=\"Primary Insurance\"                    \n          class=\"txt medium shortTxt\">\n        <datalist id=\"insuranceList\" >\n          <option value=\"{{ ins }} \" *ngFor=\"let ins of insurances\"></option>           \n        </datalist>\n        \n      </div>      \n\n      <div>\n        <ion-label position=\"stacked\" class=\"label\">Diagnosis *</ion-label>\n        <ion-input  [ngModel]=\"patientDetails?.diagnosis\" required placeholder=\"Diagnosis\" name=\"diagnosis\" autofocus clearInput inputmode=\"text\" class=\"medium shortTxt\" ></ion-input>\n\n        <!-- <input list=\"diagnosisList\" name=\"diagnosis\" ngModel required placeholder=\"Diagnosis\" class=\"txt medium shortTxt\">                  \n        <datalist id=\"diagnosisList\">\n          <option value=\"{{ diag }}\" *ngFor=\"let diag of diagnosis\"> {{ diag  }}</option>\n        </datalist> -->\n      </div>\n      <div>\n        <ion-label position=\"stacked\" class=\"label\">Reason for Hospice Now</ion-label>\n        <ion-textarea [ngModel]=\"patientDetails?.note\" name=\"note\" placeholder=\"Enter more information here\" rows=\"2\" class=\"medium\" ></ion-textarea>\n      </div>\n      <div style=\"clear:both\">\n      <ion-button strong routerLink=\"/page2\" [queryParams]=\"{withHeader:hasHeader, patientContact:patForm.value.patContact}\" (click)=\"goBack(patForm)\">Back</ion-button>\n      <ion-button [disabled]=\"contact.invalid\" strong routerLink=\"/complete\" [queryParams]=\"{withHeader:hasHeader}\" class=\"ion-float-right\"  style=\"margin-right: 5px;\" (click)=\"submit(patForm)\">Submit</ion-button>\n      <!-- <ion-button  strong routerLink=\"/complete\" class=\"ion-float-right\"  style=\"margin-right: 5px;\" (click)=\"submit(patForm)\">Submit</ion-button> -->\n      </div>\n      </div>\n      </form>\n  </ion-col>\n  </ion-row>\n  </ion-grid> \n    \n</ion-content>\n";
    /***/
  },

  /***/
  "./src/app/page3/page3-routing.module.ts":
  /*!***********************************************!*\
    !*** ./src/app/page3/page3-routing.module.ts ***!
    \***********************************************/

  /*! exports provided: Page3PageRoutingModule */

  /***/
  function srcAppPage3Page3RoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Page3PageRoutingModule", function () {
      return Page3PageRoutingModule;
    });
    /* harmony import */
    ...
    var _page3_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./page3.page */
    "./src/app/page3/page3.page.ts");

    var routes = [{
      path: '',
      component: _page3_page__WEBPACK_IMPORTED_MODULE_3__["Page3Page"]
    }];

    var Page3PageRoutingModule = function Page3PageRoutingModule() {
      _classCallCheck(this, Page3PageRoutingModule);
    };

    Page3PageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPage3Page3ModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Page3PageModule", function () {
    ...
    var _page3_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./page3-routing.module */
    "./src/app/page3/page3-routing.module.ts");
    /* harmony import */


    var _page3_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./page3.page */
    "./src/app/page3/page3.page.ts"); //import { ForbiddenValidatorDirective } from '../common/validator/forbidden-value.directive';


    var Page3PageModule = function Page3PageModule() {
      _classCallCheck(this, Page3PageModule);
    };

    Page3PageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _page3_routing_module__WEBPACK_IMPORTED_MODULE_6__["Page3PageRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"]],
      declarations: [_page3_page__WEBPACK_IMPORTED_MODULE_7__["Page3Page"]]
    })], Page3PageModule);
    /***/
  },

  /***/
  "./src/app/page3/page3.page.scss":
  /*!***************************************!*\
    !*** ./src/app/page3/page3.page.scss ***!
    \***************************************/
  ...
  /***/
  function srcAppPage3Page3PageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "ion-header {\n  display: none;\n}\n\nion-grid {\n  opacity: 1;\n  padding: 0;\n  background-color: var(--ion-color-light);\n}\n\nion-grid div {\n  padding: 0;\n  margin: 0 5px 20px 5px;\n}\n\n.label {\n  font-size: 1.2rem;\n  line-height: 1;\n  font-family: \"myriad-pro\", \"Arial\";\n  font-weight: 400;\n  margin: 0px;\n}\n\n.btn {\n  border-radius: 4px;\n  font-weight: 600;\n}\n\n@media (min-width: 768px) {\n  ion-content {\n    --background: none;\n  }\n\n  ion-grid {\n    border: 2px dotted #005eab;\n    position: absolute;\n    top: 10px;\n    left: 25%;\n    width: 50%;\n  }\n\n  .exShortTxt {\n    width: 15rem;\n  }\n\n  .shortTxt {\n    width: 25rem;\n  }\n\n  .longTxt {\n    width: 50rem;\n  }\n}\n\ndiv.img_header {\n  position: relative;\n  margin: 0;\n  clear: left;\n  text-align: center;\n  /* Add This*/\n}\n\n.img_cover {\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n  width: 100%;\n}\n\n.titleTxt {\n  font-size: 30px;\n  font-weight: 600;\n  font-style: italic;\n  display: block;\n  margin: 20px 0 20px 0;\n}\n\nion-input.ng-touched.ng-invalid,\ninput.ng-touched.ng-invalid,\nion-select.ng-touched.ng-invalid {\n  border: 2px solid red;\n}\n\nion-input, ion-select {\n  padding: 7px 12px;\n  margin-top: 5px;\n  outline: none;\n}\n\n.txt {\n  padding: 7px 12px;\n  margin-top: 5px;\n  display: block;\n  outline: none;\n}\n\nion-select.full {\n  max-width: 100% !important;\n  width: 100% !important;\n  /* Applies to the value and placeholder color */\n  /* Set a different placeholder color */\n  /* Set full opacity on the placeholder */\n}\n\n.hline {\n  display: block;\n  height: 1px;\n  border: 0;\n  border-top: 1px solid #ccc;\n  margin: 1em 0;\n  padding: 0;\n}\n\n.medium {\n  border: 1px solid black;\n  border-radius: 4px;\n  background-color: var(--ion-color-light);\n  padding: 7px 12px;\n  margin-top: 5px;\n  color: var(--ion-color-dark);\n  outline: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppPage3Page3PageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Page3Page", function () {
      return Page3Page;
    });
    /* harmony import */
    ...
    var Page3Page = /*#__PURE__*/function () {
      function Page3Page(stateService, data, http, activatedRoute) {
        ...
        this.API_SERVER = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].API_SERVER;
        this.defaultState = "NY";
        this._patientStorageKey = "PatientContact";
        this._physicianStorageKey = "PhysicianContact"; //private diagn = ['ALS', "Alzheimer's", "Cancer", "Heart Disease", "HIV", "AIDS", "Liver disease", "Lung disease", "Renal disease", "Sepsis", "Etc"];

        this.insurances = ["MEDICARE- HOSPICE", "NATIONAL BENEFIT FUND HOSPICE", "AETNA HOSPICE", "AFFINITY", "AMERICHOICE PERSONAL CARE PLUS", "AMIDACARE MGD MCAID  HOSPICE", "BEREAVEMENT", "CENTERLIGHT HEALTHCARE PACE HOSPICE", "CHAMPVA VA HEALTH ADMIN CENTER HOSPICE", "CHARITY - HOSPICE - ORDER DRIVEN", "CHRISTIAN BROTHERS INSURANCE HOSPICE", "CIGNA", "COMPREHENSIVE CARE MANAGEMENT  CORP", "DEPT OF VETERANS AFFAIRS HOSPICE", "EMPIRE BC/BS", "FIDELIS", "GEHA HOSPICE", "GHI HOSPICE", "GROUP HEALTH INC", "GUILDNET GBR ", "HEALTHCARE PARTNERS (HERITAGE) HOSPICE", "HEALTHFIRST", "HEALTHPLUS", "HEALTHSMART BENEFIT SOLUTION HOSPICE", "HIP", "MEDICAID HOSPICE", "UNITED MGD MCAID HOSPICE", "WELLCARE MGD MCAID HOSPICE", "MAGNACARE HOSPICE", "MAIL HANDLERS BENEFIT FUND HOSPICE", "MCD NH PENDING HOSPICE", "MEDICAL MUTUAL HOSPICE", "METROPLUS", "MONTEFIORE HMO LLC", "NHRB MLTC/NO PAY", "NHRB PRIVATE PAY/NOPAY", "NIPPON LIFE INSURANCE OF AMERICA HOSPICE", "OSCAR INSURANCE COR HOSPICE", "OXFORD HOSPICE", "PATIENT COPAY & DEDUCTIBLES HOSPICE", "PATIENT SURPLUS HOSPICE", "POMCO HOSPICE", "PRIVATE PAY - ORDER DRIVEN - HOSPICE", "QUALCARE HOSPICE", "SECURE HORIZONS", "SENIOR HEALTH PARTNERS MLTC ", "TRAVEL CARE SERVICES HOSPICE", "TRICARE NORTH REGION HOSPICE", "UNITED", "US FAMILY HEALTH PLAN HOSPICE", "VNSNY CHOICE", "WELLCARE", "WTC FIRE DEPT OF NY HEALTH PROGRAM HOSPICE"];
        this.formHeaderUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].contextRoot + '/assets/form-header.png';
      }

      _createClass(Page3Page, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          console.log("2. Init patient page"); //this.data.currentMessage.subscribe(message => this.physicanContact = message)

          this.physicanContact = JSON.parse(sessionStorage.getItem(this._physicianStorageKey));
          var details = sessionStorage.getItem(this._patientStorageKey);
          this.patientDetails = details ? JSON.parse(details) : null;
        ...
        value: function formatPhone(phone) {
          ...
          if (cleaned.length === 10) {
            var formatedStr = cleaned.substr(0, 3) + "-" + cleaned.substr(3, 3) + "-" + cleaned.substr(6, 4);
            phone.value = formatedStr;
          } else {//phone.value = '(000) 000-0000'
        ...
        key: "formatDob",
        value: function formatDob(dob) {
          var value = dob.value;
          console.log("orginal:" + value);
          if (value.length < 6) return;
          value = value.replace(/\s|-/g, ""); // remove all spaces and '-'
          // assign back the cleaned text
          //dob.value = value; 
          ...
          if (parts.length !== 3) {
            // all digits, no seperator
            parts[0] = value.substr(0, 2); //MM

            parts[1] = value.substr(2, 2); //DD

            parts[2] = value.substr(4); //YY or YYYY
          }
          ...
          if (y <= 2100 && y >= 1900 && m > 0 && m < 13 && d > 0 && d < 32) {
            //dob.value = parts.join('/');    
            dob.value = parts[0].padStart(2, "0") + "/" + parts[1].padStart(2, "0") + "/" + parts[2];
          } else {
            dob.value += " ";
          }
        }
        ...
        value: function submit(form) {
          //let text = JSON.stringify(form.value);
          //console.log(form.value.patContact );
          //let r: Referal = new Referal(JSON.parse(localStorage.getItem(this.storageKey)), form.value.patContact);
          var r = new Referal(this.physicanContact, form.value.patContact);
          var refText = r.getReferal();
          this.data.changeMessage(refText);
          console.log("Before calling API: " + refText);
          this.sendEmail(r);
          sessionStorage.setItem(this._patientStorageKey, ''); //clear off patient details

          sessionStorage.setItem(this._physicianStorageKey, ''); //clear off patient details

          this.patientDetails = null;
        }
      }, {
        key: "sendEmail",
        value: function sendEmail(refer) {
          var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpParams"]();
          params = params.append('value', refer.getReferal()).append('accountId', 'dm5zbnlfcmVmZXJyYWxfc2VydmljZQ==');
          console.log("calling sendEmail. ", this.API_SERVER);
          this.http.get(this.API_SERVER, {
            params: params
        ...
        key: "goBack",
        value: function goBack(form) {
          this.patientDetails = JSON.stringify(form.value.patContact);
          sessionStorage.setItem(this._patientStorageKey, JSON.stringify(form.value.patContact));
        }
      }, {
        key: "debugDetail",
        get: function get() {
          return JSON.stringify(this.patientDetails);
        }
      }]);
    ...
    Page3Page.ctorParameters = function () {
      return [{
    ...
    Page3Page = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      selector: 'app-page3',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./page3.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/page3/page3.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./page3.page.scss */
      "./src/app/page3/page3.page.scss"))["default"]]
    })], Page3Page);

    var Referal = /*#__PURE__*/function () {
      function Referal(physician, patient) {
        _classCallCheck(this, Referal);

        this.physician = physician;
        this.patient = patient;
        var today = new Date();
        this.submissionTime = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
      }

      _createClass(Referal, [{
        key: "getReferal",
        value: function getReferal() {
          delete this.physician.save_info;
...
//# sourceMappingURL=page3-page3-module-es5.js.map